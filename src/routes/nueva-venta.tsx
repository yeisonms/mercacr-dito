  ...
  const mutation = useMutation({
    mutationFn: async () => {
      ...
      return procesarVenta({
        ...
        saldoPendiente: dbTipoVenta.startsWith("Credicontado") ? calculosFinancieros.totalCreditoBase - cuotaInicial : calculosFinancieros.saldoPendiente,
        saldoContado: dbTipoVenta.startsWith("Credicontado") ? calculosFinancieros.saldoPendiente : undefined,
    ...
    onSuccess: (res) => {
      ...
      setTicketVentaData({
        ...
        saldoPendiente: tipoVenta === "Contado" ? 0 : (tipoVenta.includes("Credicontado") ? calculosFinancieros.totalCreditoBase - cuotaInicial : calculosFinancieros.saldoPendiente),
        saldoCredicontado: tipoVenta.includes("Credicontado") ? calculosFinancieros.saldoPendiente : null,
        fechaLimiteCredicontado: tipoVenta.includes("Credicontado") ? calculosFinancieros.fechaFinalEstimada : null,
